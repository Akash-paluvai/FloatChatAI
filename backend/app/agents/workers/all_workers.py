...
class RetrievalAgent(BaseAgent):
    def __init__(self):
        super().__init__(
            name="RetrievalAgent",
            description="Retrieval Specialist",
            capabilities=["semantic_search", "keyword_search", "hybrid_retrieval"],
            supported_tools=["RetrievalTool"]
        )
...
class DatabaseAgent(BaseAgent):
    def __init__(self):
        super().__init__(
            name="DatabaseAgent",
            description="PostGIS & Database Architect",
            capabilities=["spatial_query", "postgis_search", "depth_query"],
            supported_tools=["PostgreSQLTool"]
        )
...
class StatisticsAgent(BaseAgent):
    def __init__(self):
        super().__init__(
            ...
            description="Oceanographic Statistician",
            capabilities=["statistics_calculation", "climatology", "anomaly_detection"],
            supported_tools=["StatisticsTool"]
        )
...
class KnowledgeGraphAgent(BaseAgent):
    def __init__(self):
        super().__init__(
            ...
            description="Knowledge Graph Specialist",
            capabilities=["graph_search", "relationship_traversal"],
            supported_tools=["KnowledgeGraphTool"]
        )
...
class VisualizationAgent(BaseAgent):
    def __init__(self):
        super().__init__(
            ...
            description="Scientific Visualization Engineer",
            capabilities=["3d_contour", "depth_profile", "trajectory_map", "heatmap"],
            supported_tools=["VisualizationTool"]
        )
...
class ReasoningAgent(BaseAgent):
    def __init__(self):
        super().__init__(
            name="ReasoningAgent",
            description="Scientific Reasoning Expert",
...
class ValidationAgent(BaseAgent):
    def __init__(self):
        super().__init__(
            ...
            description="Scientific Quality Gatekeeper",
...
class ResponseAgent(BaseAgent):
    def __init__(self):
        super().__init__(
            name="ResponseAgent",
            description="Multimodal Response Builder",
